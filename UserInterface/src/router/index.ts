...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/ConvenioEspecifico/:id', name: 'VistaConvenioEspecifico', component: ConvenioEspecificoView, props: true },
    { path: '/editConvenioMarco/:id', name: 'EditConvenioMarco', component: EditConvenioMarcoView, props: true } ,
