        ...
        <div class="row g-3 align-items-center">
            ...
            <div class="col-auto">
                <div class="form-check form-switch d-flex align-items-center">
                    <input class="form-check-input" type="checkbox" role="switch" id="switchOrdenAntiguedad"
                        v-model="esAscendente">
                    <label class="form-check-label ms-2" for="switchOrdenAntiguedad">
                        Orden: <strong>{{ esAscendente ? 'Más antiguos primero' : 'Más nuevos primero' }}</strong>
                    </label>
                </div>
            </div>
