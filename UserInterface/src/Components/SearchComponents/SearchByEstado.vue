...
<template>
    <div class="card p-3 shadow-sm rounded-0 border-0 border-start border-4 border-primary custom-card-width">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto">
                <select class="form-select form-select-sm" v-model="estadoSeleccionado" @change="handleSelectChange"
            ...
            <div class="col-auto">
                <button class="btn btn-sm btn-primary" @click="handleSearch" :disabled="estadoSeleccionado === null">
