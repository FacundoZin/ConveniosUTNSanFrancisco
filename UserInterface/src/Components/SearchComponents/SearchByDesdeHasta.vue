    ...
    <div class="card p-3 shadow-sm rounded-0 border-0 border-start border-4 border-primary custom-card-width">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto">
                ...
                <input type="date" class="form-control form-control-sm" id="inputFechaDesde" v-model="fechaDesde"
                    @input="handleFechaChange" aria-label="Seleccionar fecha desde"
                    :class="{ 'is-invalid': mostrarAlerta }" placeholder="Desde">
            </div>
            ...
            <div class="col-auto">
                ...
                <input type="date" class="form-control form-control-sm" id="inputFechaHasta" v-model="fechaHasta"
                    @input="handleFechaChange" aria-label="Seleccionar fecha hasta"
                    :class="{ 'is-invalid': mostrarAlerta }" placeholder="Hasta">
