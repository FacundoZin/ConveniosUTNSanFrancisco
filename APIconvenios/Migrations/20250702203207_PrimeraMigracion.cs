        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RolInvolucrado = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    numeroconvenio = table.Column<int>(type: "int", nullable: false),
                    EmpresaId = table.Column<int>(type: "int", nullable: false),
                    FechaFirmaConvenio = table.Column<DateOnly>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FechaFirmaConvenio = table.Column<DateOnly>(type: "date", nullable: false),
                    FechaInicioActividades = table.Column<DateOnly>(type: "date", nullable: false),
                    FechaFinConvenio = table.Column<DateOnly>(type: "date", nullable: false),
                    ConvenioMarcoId = table.Column<int>(type: "int", nullable: false),
                    SecretariaInvolucrada = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ConveniosEspecificosId = table.Column<int>(type: "int", nullable: false),
                    InvolucradosId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
